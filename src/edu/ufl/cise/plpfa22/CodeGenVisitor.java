...
public class CodeGenVisitor implements ASTVisitor, Opcodes {
	...
	public Object visitStatementCall(StatementCall statementCall, Object arg) throws PLPException {
		...
		String currentPath = fullyQualifiedClassName+"$"+((ProcDec) statementCall.ident.getDec()).ident.getStringValue();
		String descriptor = "(L"+ currentPath+";)V";
		mv.visitTypeInsn(NEW, currentPath);
		mv.visitInsn(DUP);
		mv.visitVarInsn(ALOAD, 0);
		mv.visitMethodInsn(INVOKESPECIAL, currentPath, "<init>", descriptor, false);
		mv.visitMethodInsn(INVOKEVIRTUAL, currentPath, "run", "()V", false);
		mv.visitInsn(RETURN);
		return null;
	}
	...
	public Object visitExpressionIdent(ExpressionIdent expressionIdent, Object arg) throws PLPException {
		...
		if(expressionIdent.getDec().firstToken.getStringValue().equals("CONST")){
			...
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETFIELD, fullyQualifiedClassName,((VarDec) expressionIdent.getDec()).ident.getStringValue(), JVMType);
		}
		return null;
	}
	...
	public Object visitProcedure(ProcDec procDec, Object arg) throws PLPException {
		ClassWriter procWriter = new ClassWriter(ClassWriter.COMPUTE_FRAMES);
		String currentClassName = fullyQualifiedClassName+"$"+procDec.ident.getStringValue();
		procWriter.visit(V16,  ACC_SUPER, currentClassName, null, "java/lang/Object", new String[] { "java/lang/Runnable" });
		FieldVisitor fieldVisitor = procWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", ""+fullyQualifiedClassName+";", null, null);
		fieldVisitor.visitEnd();
		MethodVisitor methodVisitor = classWriter.visitMethod(0, "<init>", "(L"+fullyQualifiedClassName+";)V", null, null);
		methodVisitor.visitCode();
		methodVisitor.visitVarInsn(ALOAD, 0);
		methodVisitor.visitVarInsn(ALOAD, 1);
		methodVisitor.visitFieldInsn(PUTFIELD, currentClassName, "this$0", "L"+fullyQualifiedClassName+";");
		methodVisitor.visitVarInsn(ALOAD, 0);
		methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V",false);
		methodVisitor.visitInsn(RETURN);
		...
		if (procDec.block != null) {
			procDec.block.visit(this, procWriter);
		}

		procWriter.visitEnd();

		GenClass procClass = new GenClass(currentClassName,procWriter.toByteArray());
		output.add(procClass);
		return null;
	}
	...
	public Object visitIdent(Ident ident, Object arg) throws PLPException {
		...
		String JVMType = (etype.equals(Type.NUMBER) ? "I" : (etype.equals(Type.BOOLEAN) ? "Z" : "Ljava/lang/String;"));
		mv.visitFieldInsn(PUTFIELD,fullyQualifiedClassName,ident.firstToken.getStringValue(),JVMType);
		return null;
	}
